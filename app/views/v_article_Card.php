...
<div class="row">
    ...
    <div class="col-md-6 col-sm-6 col-xs-6">
        <form class="text-center mt-4" action="/catalog/edit/" method="post">
            ...
            <div class="row">
                <div class="col-md-11">
                    <input type="text" name="title" class="form-control mb-2 text-dark text-center " value="<?= $content_data[0]['title'];?>"/>                    
                </div>
                <div class="col-md-1">
                    <input type="text" name="status" class="form-control mb-2 text-center" value="<?= $content_data[0]['status'];?>" />                    
                </div>
            </div>
